<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/var/www/html/Blog/public/../application/index/view/user_log/loginlog.html";i:1527902923;s:68:"/var/www/html/Blog/public/../application/index/view/common/base.html";i:1528290307;s:68:"/var/www/html/Blog/public/../application/index/view/common/page.html";i:1528291986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>登录日志--JS_chen 博客后台系统</title>
    <meta charset="utf-8">
...
<h1><i class="fa fa-edit"></i> 管理员登录日志</h1>
    ...
    <li class="breadcrumb-item">登陆日志</li>
    ...
    <div class="tile">
        <table class="table table-bordered">
          ...
          <tbody>
          	<?php if(is_array($loginlogs) || $loginlogs instanceof \think\Collection || $loginlogs instanceof \think\Paginator): $i = 0; $__LIST__ = $loginlogs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$loginlog): $mod = ($i % 2 );++$i;?>
	            <tr>
	              <td><?php echo $loginlog['id']; ?></td>
	              <td><?php echo $loginlog['username']; ?></td>
	              <td><?php echo $loginlog['ip']; ?></td>
	              <td><?php echo $loginlog['create_time']; ?></td>
	            </tr>
    ...
    <?php endif; if($current_page>5): if(($current_page+6)>$pages): $__FOR_START_1550338634__=$current_page-5;$__FOR_END_1550338634__=$pages+1;for($page=$__FOR_START_1550338634__;$page < $__FOR_END_1550338634__;$page+=1){ if($page==$current_page): ?>
                ...
                <?php endif; } else: $__FOR_START_2063861906__=$current_page-5;$__FOR_END_2063861906__=$current_page+6;for($page=$__FOR_START_2063861906__;$page < $__FOR_END_2063861906__;$page+=1){ if($page==$current_page): ?>
                    <li class="paginate_button page-item active">
                        <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                    </li>
                <?php else: ?>
                ...
                <?php endif; } endif; else: $__FOR_START_1576928476__=1;$__FOR_END_1576928476__=11;for($page=$__FOR_START_1576928476__;$page < $__FOR_END_1576928476__;$page+=1){ if($page==$current_page): ?>
                <li class="paginate_button page-item active">
                    <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                </li>
            <?php else: ?>
