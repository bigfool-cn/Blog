<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\share\list.html";i:1527750877;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\base.html";i:1527667540;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\page.html";i:1527749928;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>分享列表--JS_chen 博客后台系统</title>
    <meta charset="utf-8">
...
<h1><i class="fa fa-edit"></i> 分享列表</h1>
   ...
   <div class="tile">
          	...
          	<?php if(is_array($shares) || $shares instanceof \think\Collection || $shares instanceof \think\Paginator): $i = 0; $__LIST__ = $shares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$share): $mod = ($i % 2 );++$i;?>
	            <tr>
	              ...
	              <td><?php echo $share['title']; ?></td>
	          	  <td><?php echo $share['tag']['name']; ?></td>
	          	  <td><img src="<?php echo $share['image']; ?>" width="50px" height="25px" /></td>
	              <td><?php echo $share['create_time']; ?></td>
	              <td><a href="<?php echo url('index/share/edit'); ?>?id=<?php echo $share['id']; ?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="<?php echo $share['id']; ?>" onclick="toDelete(<?php echo $share['id']; ?>)" style="color: red;cursor:pointer">删除</a></td>
	            </tr>
    ...
    <?php endif; if($current_page>5): if(($current_page+6)>$pages): $__FOR_START_26871__=$current_page-5;$__FOR_END_26871__=$pages+1;for($page=$__FOR_START_26871__;$page < $__FOR_END_26871__;$page+=1){ if($page==$current_page): ?>
                ...
                <?php endif; } else: $__FOR_START_28106__=$current_page-5;$__FOR_END_28106__=$current_page+6;for($page=$__FOR_START_28106__;$page < $__FOR_END_28106__;$page+=1){ if($page==$current_page): ?>
                    <li class="paginate_button page-item active">
                        <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                    </li>
                <?php else: ?>
                ...
                <?php endif; } endif; else: $__FOR_START_30929__=1;$__FOR_END_30929__=$pages+1;for($page=$__FOR_START_30929__;$page < $__FOR_END_30929__;$page+=1){ if($page==$current_page): ?>
                <li class="paginate_button page-item active">
                    <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                </li>
            <?php else: ?>
...
<script>
	function toDelete(id){
		$.ajax({
			cache:false,
			type:"POST",
			url:"<?php echo url('index/share/delete'); ?>",
			dataType:"json",
			data:{"id":id},
			async:true,
