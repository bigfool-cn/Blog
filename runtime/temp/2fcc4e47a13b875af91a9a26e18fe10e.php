<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/home\view\index\about.html";i:1527902219;s:80:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/home\view\index\base.html";i:1525419494;}*/ ?>
...
<article>
  <div class="contain">
    ...
    <div class="about left">
      ...
      <div class="blog" data-scroll-reveal="enter top" id="blog">
      </div>
      <h2>About my blog</h2>
  ...
  function toImage() {
      ...
      $.post("<?php echo url('/home/index/getImage'); ?>",{username:username},function (data) {
          if(data.status==200){
              ...
              $("#blog").append("<audio src='/uploads/好久不见.mp3' autoplay>\n' + '您的浏览器不支持 audio 标签。\n' + '</audio>");
              $("#getinfo").remove();
          }else{
              alert("输入名字不正确")
          }
