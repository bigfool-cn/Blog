<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\user_log\loginlog.html";i:1527750878;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\base.html";i:1527667540;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\page.html";i:1527749928;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<h1><i class="fa fa-edit"></i> 管理员登录日志</h1>
    ...
    <?php endif; if($current_page>5): if(($current_page+6)>$pages): $__FOR_START_19716__=$current_page-5;$__FOR_END_19716__=$pages+1;for($page=$__FOR_START_19716__;$page < $__FOR_END_19716__;$page+=1){ if($page==$current_page): ?>
                ...
                <?php endif; } else: $__FOR_START_1848__=$current_page-5;$__FOR_END_1848__=$current_page+6;for($page=$__FOR_START_1848__;$page < $__FOR_END_1848__;$page+=1){ if($page==$current_page): ?>
                    <li class="paginate_button page-item active">
                        <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                    </li>
                <?php else: ?>
                ...
                <?php endif; } endif; else: $__FOR_START_28964__=1;$__FOR_END_28964__=$pages+1;for($page=$__FOR_START_28964__;$page < $__FOR_END_28964__;$page+=1){ if($page==$current_page): ?>
                <li class="paginate_button page-item active">
                    <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                </li>
            <?php else: ?>
