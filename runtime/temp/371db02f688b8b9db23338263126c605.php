<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"/var/www/html/Blog/public/../application/index/view/life/list.html";i:1527902922;s:68:"/var/www/html/Blog/public/../application/index/view/common/base.html";i:1528290307;s:68:"/var/www/html/Blog/public/../application/index/view/common/page.html";i:1528292409;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>日记列表--JS_chen 博客后台系统</title>
    <meta charset="utf-8">
...
<h1><i class="fa fa-edit"></i> 日记列表</h1>
   ...
   <div class="tile">
          	...
          	<?php if(is_array($lifes) || $lifes instanceof \think\Collection || $lifes instanceof \think\Paginator): $i = 0; $__LIST__ = $lifes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$life): $mod = ($i % 2 );++$i;?>
	            <tr>
	              ...
	              <td><?php echo $life['title']; ?></td>
	          	  <td><img src="<?php echo $life['img_url']; ?>" width="60px" height="30px" /></td>
	              <td><?php echo $life['add_time']; ?></td>
	              <td><a id="<?php echo $life['id']; ?>" onclick="toDelete(<?php echo $life['id']; ?>)" style="color: red;cursor:pointer">删除</a></td>
	            </tr>
    ...
    <?php endif; if($current_page>5): if(($current_page+6)>$pages): $__FOR_START_341008967__=$current_page-5;$__FOR_END_341008967__=$pages+1;for($page=$__FOR_START_341008967__;$page < $__FOR_END_341008967__;$page+=1){ if($page==$current_page): ?>
                ...
                <?php endif; } else: $__FOR_START_1238310355__=$current_page-5;$__FOR_END_1238310355__=$current_page+6;for($page=$__FOR_START_1238310355__;$page < $__FOR_END_1238310355__;$page+=1){ if($page==$current_page): ?>
                    <li class="paginate_button page-item active">
                        <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                    </li>
                <?php else: ?>
                ...
                <?php endif; } endif; else: if($pages>11): $__FOR_START_779139272__=1;$__FOR_END_779139272__=11;for($page=$__FOR_START_779139272__;$page < $__FOR_END_779139272__;$page+=1){ if($page==$current_page): ?>
                    <li class="paginate_button page-item active">
                        <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                    </li>
                <?php else: ?>
                ...
                <?php endif; } else: $__FOR_START_399643566__=1;$__FOR_END_399643566__=$pages;for($page=$__FOR_START_399643566__;$page < $__FOR_END_399643566__;$page+=1){ if($page==$current_page): ?>
                    <li class="paginate_button page-item active">
                        <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                    </li>
                <?php else: ?>
...
<script>
	function toDelete(id){
		$.ajax({
			cache:false,
			type:"POST",
			url:"<?php echo url('index/life/delete'); ?>",
			dataType:"json",
			data:{"id":id},
			async:true,
