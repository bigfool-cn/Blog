<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\share\add.html";i:1527667909;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\base.html";i:1527667540;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>添加分享--JS_chen 博客后台系统</title>
    <meta charset="utf-8">
...
<h1><i class="fa fa-edit"></i> 添加分享</h1>
	...
	<?php endif; ?>
	<form action="<?php echo url('index/share/add'); ?>" method="post" enctype="multipart/form-data" onsubmit="return validForm()">
