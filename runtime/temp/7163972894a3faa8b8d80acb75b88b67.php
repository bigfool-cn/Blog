<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/var/www/html/Blog/public/../application/index/view/article/edit.html";i:1527902922;s:68:"/var/www/html/Blog/public/../application/index/view/common/base.html";i:1527902922;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>修改文章--JS_chen 博客后台系统</title>
    <meta charset="utf-8">
...
<h1><i class="fa fa-edit"></i> 修改文章</h1>
	...
	<?php endif; ?>
	<form action="<?php echo url('index/article/edit'); ?>" method="post" enctype="multipart/form-data" onsubmit="return validForm()">
		<input type="hidden" name="id" value="<?php echo $article['id']; ?>" />
		<div class="form-group">
			<label class="control-label">标题:</label>
			<input class="form-control" type="text" id="title" name="title" value="<?php echo $article['title']; ?>">
		</div>
		<div class="form-group">
			<label class="control-label">作者:</label>
			<input class="form-control" type="text" id="author" name="author" value="<?php echo $article['author']; ?>">
		</div>
		<div class="form-group">
			...
			<select class="form-control" id="tag" name="tag">
				...
				<?php if(is_array($tags) || $tags instanceof \think\Collection || $tags instanceof \think\Paginator): $i = 0; $__LIST__ = $tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?>
					<option value="<?php echo $tag['id']; ?>" <?php if($article['tag_id']==$tag['id']): ?>selected<?php endif; ?>><?php echo $tag['name']; ?></option>
		...
		<div class="form-group">
	        ...
	        <div class="col-lg-3" style="margin-left: -14px">
            	<img class="form-control" id="imageShow" name="pic" width="150" height="140" src="<?php echo $article['image']; ?>"/>
        	</div>
	    ...
	    <div class="form-group">
          ...
          <?php echo $article['desc']; ?></textarea>
          字数剩余:<span id="word">140</span><span>/140</span>
	    </div>
	    <div class="form-group">
	        <label class="control-label">文章内容:</label>
	        <script type="text" id="EditorId" name="content"><?php echo $article['content']; ?></script>
	    </div>
