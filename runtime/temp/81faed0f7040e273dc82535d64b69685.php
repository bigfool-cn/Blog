<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\user_log\operatelog.html";i:1527750879;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\base.html";i:1527667540;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\page.html";i:1527749928;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<h1><i class="fa fa-edit"></i> 管理员操作日志</h1>
    ...
    <?php endif; if($current_page>5): if(($current_page+6)>$pages): $__FOR_START_18127__=$current_page-5;$__FOR_END_18127__=$pages+1;for($page=$__FOR_START_18127__;$page < $__FOR_END_18127__;$page+=1){ if($page==$current_page): ?>
                ...
                <?php endif; } else: $__FOR_START_18600__=$current_page-5;$__FOR_END_18600__=$current_page+6;for($page=$__FOR_START_18600__;$page < $__FOR_END_18600__;$page+=1){ if($page==$current_page): ?>
                    <li class="paginate_button page-item active">
                        <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                    </li>
                <?php else: ?>
                ...
                <?php endif; } endif; else: $__FOR_START_16253__=1;$__FOR_END_16253__=$pages+1;for($page=$__FOR_START_16253__;$page < $__FOR_END_16253__;$page+=1){ if($page==$current_page): ?>
                <li class="paginate_button page-item active">
                    <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                </li>
            <?php else: ?>
