<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\article\list.html";i:1527750782;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\base.html";i:1527667540;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\page.html";i:1527749928;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<h1><i class="fa fa-edit"></i> 文章列表</h1>
   ...
   <div class="tile">
    ...
    <?php endif; if($current_page>5): if(($current_page+6)>$pages): $__FOR_START_11046__=$current_page-5;$__FOR_END_11046__=$pages+1;for($page=$__FOR_START_11046__;$page < $__FOR_END_11046__;$page+=1){ if($page==$current_page): ?>
                ...
                <?php endif; } else: $__FOR_START_24651__=$current_page-5;$__FOR_END_24651__=$current_page+6;for($page=$__FOR_START_24651__;$page < $__FOR_END_24651__;$page+=1){ if($page==$current_page): ?>
                    <li class="paginate_button page-item active">
                        <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                    </li>
                <?php else: ?>
                ...
                <?php endif; } endif; else: $__FOR_START_18764__=1;$__FOR_END_18764__=$pages+1;for($page=$__FOR_START_18764__;$page < $__FOR_END_18764__;$page+=1){ if($page==$current_page): ?>
                <li class="paginate_button page-item active">
                    <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                </li>
            <?php else: ?>
