<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\life\list.html";i:1527668261;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\base.html";i:1527667540;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<h1><i class="fa fa-edit"></i> 日记列表</h1>
   ...
   <div class="tile">
        ...
        <ul class="pagination">
	    	...
	    	<?php endif; $__FOR_START_21742__=1;$__FOR_END_21742__=$pages+1;for($page=$__FOR_START_21742__;$page < $__FOR_END_21742__;$page+=1){ if($page==$current_page): ?>
