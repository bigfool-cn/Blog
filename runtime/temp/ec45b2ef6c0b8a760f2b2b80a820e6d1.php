<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/home\view\index\download.html";i:1527670048;s:80:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/home\view\index\base.html";i:1525419494;}*/ ?>
  ...
  <div class="contain">
    <div class="blog" data-scroll-reveal="enter top" >
      <?php if(is_array($shares) || $shares instanceof \think\Collection || $shares instanceof \think\Paginator): $i = 0; $__LIST__ = $shares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$share): $mod = ($i % 2 );++$i;?>
        <figure>
          <ul>
            <a href="<?php echo $share['url']; ?>" target="_blank"><img class="lazy"  data-original="<?php echo $share['image']; ?>"><span>我要下载</span></a>
          </ul>
          <p><a href="<?php echo $share['url']; ?>" target="_blank"><?php echo $share['title']; ?></a></p>
