<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\location\list.html";i:1527750879;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\base.html";i:1527667540;s:82:"G:\phpstudy\PHPTutorial\WWW\Blog\public/../application/index\view\common\page.html";i:1527749928;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>位置列表--JS_chen 博客后台系统</title>
    <meta charset="utf-8">
...
<h1><i class="fa fa-edit"></i> 位置列表</h1>
    ...
    <li class="breadcrumb-item">位置列表</li>
   ...
   <div class="tile">
        <table class="table table-bordered">
          ...
          <tbody>
          	<?php if(is_array($locations) || $locations instanceof \think\Collection || $locations instanceof \think\Paginator): $i = 0; $__LIST__ = $locations;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$location): $mod = ($i % 2 );++$i;?>
	            <tr>
	              <td><?php echo $location['id']; ?></td>
	              <td><?php echo $location['x']; ?></td>
	              <td><?php echo $location['y']; ?></td>
	              <td><?php echo $location['address']; ?></td>
	              <td><?php echo $location['create_time']; ?></td>
	            </tr>
    ...
    <?php endif; if($current_page>5): if(($current_page+6)>$pages): $__FOR_START_18558__=$current_page-5;$__FOR_END_18558__=$pages+1;for($page=$__FOR_START_18558__;$page < $__FOR_END_18558__;$page+=1){ if($page==$current_page): ?>
                ...
                <?php endif; } else: $__FOR_START_506__=$current_page-5;$__FOR_END_506__=$current_page+6;for($page=$__FOR_START_506__;$page < $__FOR_END_506__;$page+=1){ if($page==$current_page): ?>
                    <li class="paginate_button page-item active">
                        <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                    </li>
                <?php else: ?>
                ...
                <?php endif; } endif; else: $__FOR_START_25429__=1;$__FOR_END_25429__=$pages+1;for($page=$__FOR_START_25429__;$page < $__FOR_END_25429__;$page+=1){ if($page==$current_page): ?>
                <li class="paginate_button page-item active">
                    <a href="javascript:;" aria-controls="sampleTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $page; ?></a>
                </li>
            <?php else: ?>
